...
class BaseStorageBackend(BaseSettings):
    ...
    def __init__(self, **data):
        if self.__class__.__name__ == "BaseStorageBackend":
            raise NotImplementedError("you need to configure a storage backend")
        super().__init__(**data)

    def save_to_csv(self, df: pd.DataFrame):
        raise NotImplentedError("you need to implement the save function")

    def generate_link(self):
        raise NotImplentedError("you need to implement the generate_link function")
