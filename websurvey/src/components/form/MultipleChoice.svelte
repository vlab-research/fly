    ...
    <fieldset>
        {#each field.properties.choices as choice, index (choice.id)}
            <label
                ...
                class=" flex flex-row items-center mb-2 border-solid rounded border-indigo-500 border-2 p-2 bg-indigo-100 transition-colors ease-linear hover:bg-indigo-200 text-sm md:text-lg text-slate-600 cursor-pointer">
                <input
