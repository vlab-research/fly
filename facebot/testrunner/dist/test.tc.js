...
const dean_trigger_1 = require("./dean-trigger");
...
describe('Test Bot flow Survey Integration Testing', () => {
    before(async function () {
        ...
        stack = await (0, stack_1.startStack)();
        process.env.FACEBOT_URL = stack.facebotUrl;
        process.env.BOTSERVER_URL = stack.botserverUrl;
        const pool = new pg_1.Pool({ connectionString: stack.chatbaseConnString });
        chatbase = { pool };
    ...
    after(async function () {
        ...
        if (chatbase === null || chatbase === void 0 ? void 0 : chatbase.pool)
            await chatbase.pool.end();
        if (stack)
            await (0, stack_1.stopStack)(stack);
    ...
    (0, mocha_parallel_1.default)('Basic Functionality', function () {
        ...
        it('Puts user into blocked state when given facebook error', async () => {
            ...
            await (0, sender_1.default)((0, mox_1.makeReferral)(userId, 'LDfNCy'));
            await (0, socket_1.flowMaster)(userId, testFlow);
            const state = await (0, utils_1.waitFor)(async () => {
                const s = await (0, responses_1.getState)(chatbase, userId);
                return (s === null || s === void 0 ? void 0 : s.current_state) !== 'RESPONDING' ? s : null;
            });
        ...
        it('Test chat flow with stitched forms: stitches and maintains seed', async () => {
            ...
            await (0, socket_1.flowMaster)(userId, testFlow);
            const res = await (0, utils_1.waitFor)(async () => {
                const r = await (0, responses_1.getResponses)(chatbase, userId);
    ...
    describe('Timeouts', function () {
        ...
        it('Sends timeout message response when interrupted in a timeout, then waits', async function () {
            ...
            await (0, socket_1.flowMaster)(userId, [
            ...
            await (0, utils_1.waitFor)(async () => {
                const s = await (0, responses_1.getState)(chatbase, userId);
                return (s === null || s === void 0 ? void 0 : s.current_state) === 'WAIT_EXTERNAL_EVENT' ? s : null;
            }, 30000);
            await (0, utils_1.snooze)(2000);
            await (0, dean_trigger_1.triggerDean)(stack.network, stack.deanImage, stack.deanEnv, 'timeouts');
            await (0, utils_1.snooze)(5000);
            await (0, socket_1.flowMaster)(userId, [
                [ok, fields[1], [(0, mox_1.makeTextResponse)(userId, 'LOL')]],
                [ok, fields[2], []],
            ]);
        ...
        it('Sends follow ups when the user does not respond', async function () {
            ...
            await (0, utils_1.waitFor)(() => (0, responses_1.getState)(chatbase, userId), 30000);
            await (0, dean_trigger_1.triggerDean)(stack.network, stack.deanImage, stack.deanEnv, 'followups');
            await (0, utils_1.snooze)(5000);
        ...
        it('Retries sending the message when it fails with a proper code', async function () {
            ...
            const userId = (0, uuid_1.v4)();
            const fields = (0, mox_1.getFields)('forms/LDfNCy.json');
            const errRetry = { error: { message: 'test error', code: -1 } };
